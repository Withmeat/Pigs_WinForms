...
namespace FightPigs.Main.Persistance
{
    public class gameTable
    {
        ...
        public void Step(Queue<Keys> plyr1, Queue<Keys> plyr2)
        {
            ...
            {
                Keys plyr1_step = plyr1.Dequeue();
                Keys plyr2_step = plyr2.Dequeue();
                ...
                switch(plyr1_step)
                {
                    case Keys.Up: plyr1_stepVar = stepVars[((int)Direction.Up + (int)GetValue(_p1IDX)) % 4]; break;
                    case Keys.Down: plyr1_stepVar = stepVars[((int)Direction.Down + (int)GetValue(_p1IDX)) % 4]; break; 
                    case Keys.Left: plyr1_stepVar = stepVars[((int)Direction.Left + (int)GetValue(_p1IDX)) % 4]; break;
                    case Keys.Right: plyr1_stepVar = stepVars[((int)Direction.Right + (int)GetValue(_p1IDX)) % 4]; break;
                    case Keys.Q: plyr1_stepVar = (-1, -1);
                        _fieldValue[ _p1IDX.Item1, _p1IDX.Item2 ] =
                            GetValue(_p1IDX) - 1 != (Direction) (-1) ? GetValue(_p1IDX) - 1 : (Direction) 3; ;
                        break;
                    case Keys.R: plyr1_stepVar = (-1, -1);
                        _fieldValue[ _p1IDX.Item1, _p1IDX.Item2] =
                ...
                switch (plyr2_step)
                {
                    case Keys.Up: plyr2_stepVar = stepVars[((int)Direction.Up + (int)GetValue(_p2IDX)) % 4]; break;
                    case Keys.Down: plyr2_stepVar = stepVars[((int)Direction.Down + (int)GetValue(_p2IDX)) % 4]; break;
                    case Keys.Left: plyr2_stepVar = stepVars[((int)Direction.Left + (int)GetValue(_p2IDX)) % 4]; break;
                    case Keys.Right: plyr2_stepVar = stepVars[((int)Direction.Right + (int)GetValue(_p2IDX)) % 4]; break;
                    case Keys.Q:
                        plyr2_stepVar = (-1, -1);
